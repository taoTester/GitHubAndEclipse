...
public class Constant {
	...
	public static final int EXCEL_USERNAME=1;
	public static final int EXCEL_PASSWORD=2;
	public static final int EXCEL_BROWSER=3;
	public static final int EXCEL_RESULT=4;
